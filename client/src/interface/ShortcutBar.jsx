        ...
        return (
            <div className="dashboard-tools well home_well col-xs-12">
                <ul>
                    ...
                    <li className="col-xs-2 navable navable-row" data-function="launchBrowser" data-parameters={ignitionSettings.interface.browser_url}><strong><i className="ion-earth"></i></strong> Web Browser</li>
