...
module.exports = React.createClass({
    ...
    render: function() {
        ...
        return (
                ...
                <tr className='subNavable' data-snav={this.props.navStack} data-function={this.props.functionCall} data-parameters={this.props.path} data-title={this.props.game} data-path={this.props.path}>
