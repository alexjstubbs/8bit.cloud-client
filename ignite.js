        ...
        exec('killall qmlscene', function(stderr, stdout) {
            ...
            fs.readdir('config/profiles', function(err, files) {
                ...
                if (!err) {
                    ...
                    var child = exec('setsid qtbrowser --inspector=9945 --webkit=1 --missing-image=no --websecurity=off --app-name=IgnitionOS --validate-ca=off --transparent --url='+_location + "| /usr/bin/qmlscene /boot/loading/loading-ui.qml");
